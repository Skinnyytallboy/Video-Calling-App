...
server = StreamingServer(local_ip, 2345)
receiver = AudioReceiver(local_ip, 8080)
...
def start_screen_stream():
    ...
    if platform.system() == 'Windows':
        screen_client = ScreenShareClient(text_target_ip.get(), 9999)
...
def start_audio_stream():
    ...
    audio_sender = AudioSender(text_target_ip.get(), 5555)
